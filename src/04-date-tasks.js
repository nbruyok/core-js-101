...
function timeSpanToString(startDate, endDate) {
  ...
  const hour = diff.getUTCHours().toString().padStart(2, '0');
  const min = diff.getUTCMinutes().toString().padStart(2, '0');
  const sec = diff.getUTCSeconds().toString().padStart(2, '0');
  const ms = diff.getUTCMilliseconds().toString().padStart(3, '0');
